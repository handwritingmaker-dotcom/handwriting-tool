...
The current [text to handwriting PDF generator](/tools/text-to-handwriting-pdf) accepts typed or pasted plain text. It does not upload an existing PDF, preserve a source document's layout, or run OCR. That distinction matters because “text to PDF” and “PDF to handwriting” are different tasks.
