...
const allowedUses = [
  "Creating study notes, revision pages, and printable learning material",
  "Preparing drafts, examples, worksheets, templates, and classroom-style resources",
  "Formatting content into handwritten-style pages when digital output is allowed",
  "Making personal notes, practice pages, letters, and creative mockups",
];

const avoidUses = [
  "Misrepresenting generated pages as original handwriting when original handwriting is required",
    ...
    <main className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
      <article className="rounded-[32px] border border-slate-200 bg-white p-8 shadow-card lg:p-12">
        ...
        <p className="mt-6 text-lg leading-8 text-slate-600">
          ...
          worksheets, examples, printable study material, and permitted digital formats. It should be used in ways that
          respect instructions, academic integrity, workplace rules, and the trust of readers.
        </p>
        ...
        <section className="mt-12 space-y-4 text-lg leading-8 text-slate-600">
          <h2 className="text-2xl font-semibold text-slate-950">For Students and Schools</h2>
          <p>
            If a teacher, school, college, or platform asks for original handwriting, follow that instruction. In that
            situation, HandwritingTool can still help with planning, drafting, formatting examples, and study notes
            before you write the final version yourself.
          </p>
          <p>
            If handwritten-style digital output is allowed, review the final page for readability, completeness, and
            accuracy before printing or sharing it.
          </p>
        </section>
