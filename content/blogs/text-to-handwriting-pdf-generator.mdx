...
The current [text to handwriting PDF generator](/tools/text-to-handwriting-pdf) accepts typed or pasted plain text. It does not upload an existing PDF, preserve a source document's layout, or run OCR. If your source is a PDF, follow the separate [PDF text extraction and cleanup guide](/blog/pdf-to-handwriting-converter) first.
